...
```{r full_join}
img_path <- "Images/full-join.gif"
img1 <- magick::image_read(img_path)
img1
magick::image_destroy(img1)
```
...
```{r left_join}
img_path <- "Images/left-join-extra.gif"
img2 <- magick::image_read(img_path)
img2
magick::image_destroy(img2)
```

```{r right_join}
img_path <- "Images/right-join.gif"
img5 <- magick::image_read(img_path)
img5
magick::image_destroy(img5)
```
...
```{r inner_join}
img_path <- "Images/inner-join.gif"
img3 <- magick::image_read(img_path)
img3
magick::image_destroy(img3)
```
...
```{r pivot}
img_path <- "Images/pivot.gif"
img4 <- magick::image_read(img_path)
img4
magick::image_destroy(img4)
```
