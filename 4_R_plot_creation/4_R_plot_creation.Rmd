...
Sometimes you want to show multiple plots together in one figure (for example when the journal you want to submit to has a figure limit `r emo::ji("winking_face")`).
...
There are two ways that I will show you here today. First using the package `patchwork`. You can install it directly from github:
